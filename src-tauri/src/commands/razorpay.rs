...
#[tauri::command(async)]
pub async fn create_qr(amount: u64, close_by_secs: i64) -> Result<RazorpayQrResponse> {
...
#[tauri::command(async)]
pub async fn check_payment_status(qr_code_id: String) -> Result<bool> {
    let key_id = dotenv_codegen::dotenv!("RAZORPAY_KEY_ID");
    let key_secret = dotenv_codegen::dotenv!("RAZORPAY_KEY_SECRET");
    ...
    let res_data: RazorpayPollingResponse =
